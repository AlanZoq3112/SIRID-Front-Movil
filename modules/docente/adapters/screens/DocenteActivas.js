...
export default function DocenteActivas(navigation) {
  return (
    <KeyboardAwareScrollView style={styles.container}>
      <Image source={backImage} style={styles.backImage} />
      <View style={styles.whiteSheet} />
      <SafeAreaView style={styles.form}>
        <Text style={styles.title}>Activas</Text>

        <Card containerStyle={{ borderRadius: 20, height: 140 }}>
          <Card.Title>01 CC7 Monitor Dañado</Card.Title>
          <Card.Title style={{ color: "#008f71" }}>Activa</Card.Title>
          <View
        ...
        <Card containerStyle={{ marginTop: 1, borderRadius: 20, height: 140 }}>
          <Card.Title>02 CC2 No hay Internet</Card.Title>
          <Card.Title style={{ color: "#008f71" }}>Activa</Card.Title>
